...
// Level (ngang): no mark - a, e, i, o, u, y, ă, â, ê, ô, ơ, ư
// Falling (huyền): grave - à, è, ì, ò, ù, ỳ, ằ, ầ, ề, ồ, ờ, ừ
// Rising (sắc): acute - á, é, í, ó, ú, ý, ắ, ấ, ế, ố, ớ, ứ
// Dipping (hỏi): hook - ả, ẻ, ỉ, ỏ, ủ, ỷ, ẳ, ẩ, ể, ổ, ở, ử
// Creaky (ngã): tilde - ã, ẽ, ĩ, õ, ũ, ỹ, ẵ, ẫ, ễ, ỗ, ỡ, ữ
// Heavy (nặng): dot - ạ, ẹ, ị, ọ, ụ, ỵ, ặ, ậ, ệ, ộ, ợ, ự
